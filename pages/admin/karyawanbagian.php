                        ...
                        <div class="card-body">
                              <div class="row">
                                    <div class="col-sm-6">
                                          <div class="form-group">
                                                ...
                                                <input types"text" class="form-control" name="nik" value="<?php echo $row['nik'] ?>" disabled>
                                          </div>
                                    </div>
                                    <div class="col-sm-6">
                                          <div class-"form-group">
                              ...
                              <form action="" method="post">
                                    ...
                                    <div class="row">
                                          ...
                                          <div class="col-sm-6">
                                                <div class="form-group">
                                                      <label for="tanggal_mulal">Tanggal Mulai</label>
                                                ...
                                                <tr>
                                                      ...
                                                      <td>
                                                            <form action method="POST">
                                                                  ...
                                                                  <input type="hidden" value="<?php echo $id ?>" name="karyawan_id">
                                                                  <button type="submit" name="button_delete" class="btn btn-danger btn-sm mr-1" onClick="javascipt : return confirm('Konfirmasi data akan dihapus?');">
